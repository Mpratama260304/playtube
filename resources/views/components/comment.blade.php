...
<div class="flex gap-3 {{ $level > 0 ? 'ml-12' : '' }}">
    ...
    <div class="flex-1 min-w-0">
        ...
        <div class="flex items-center gap-4 mt-2">
            @auth
                <button type="button" class="flex items-center gap-1 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 text-sm transition-colors">
